...
def plotRabiDependence(Bdirection, rabiList, transitionList, probeList=None):
    ...
    for idx, transition in enumerate(transitionList):
        ...
        for rabi in rabiList:
            ...
            theorPath = f'./D1pump{Bdirection}/Pump_D1-Cs133_Probe_D1-Cs133/{transition}/Absorption_Cs133-D1-PumpRabi={rabi:.2f}-shift=0.0-Ge=0'
