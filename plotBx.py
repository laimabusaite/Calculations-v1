...
def plotBx(rabiList, transitionList, probeList=None):
    ...
    fig = plt.figure()
    fig.canvas.set_window_title('Bx')
    plt.suptitle('Bx')
    for idx, transition in enumerate(transitionList):
        ...
        for rabi in rabiList:
            ...
            theorPath = f'./D1pumpBx/Pump_D1-Cs133_Probe_D1-Cs133/{transition}/Absorption_Cs133-D1-PumpRabi={rabi:.2f}-shift=0.0-Ge=0'#.format(rabi)
...
if __name__ == '__main__':
    ...
    plotBx(rabiList, transitionList)
